...
if 'uk_usb_sysnums' not in s:
    ...
    s = s.replace(sc_anchor, sc_anchor +
                  ...
                  '\t\t\t{ PR_ioctl,\tFILTER_SYSEXIT },\t/* usbfs device I/O proxy */\n'
                  '\t\t\t{ PR_close,\tFILTER_SYSEXIT },\n'
                  '\t\t\t{ PR_fstat,\tFILTER_SYSEXIT },\n'
                  '\t\t\t{ PR_newfstatat,\tFILTER_SYSEXIT },\n'
                  '\t\t\t{ PR_poll,\tFILTER_SYSEXIT },\t/* drive libusb event loop */\n'
...
if 'uk_wifi_sysnums' not in s:
    ...
    s = s.replace(sc_anchor, sc_anchor +
                  ...
                  '\t\t\t{ PR_socket,\tFILTER_SYSEXIT },\t/* mark nl80211 genl + AF_PACKET sockets */\n'
                  '\t\t\t{ PR_bind,\tFILTER_SYSEXIT },\t/* fake bind on the AF_PACKET dummy */\n'
                  '\t\t\t{ PR_sendmsg,\tFILTER_SYSEXIT },\t/* ferry netlink/EAPOL -> io.neoterm.wifi */\n'
                  '\t\t\t{ PR_recvmsg,\tFILTER_SYSEXIT },\n'
                  '\t\t\t{ PR_sendto,\tFILTER_SYSEXIT },\t/* AF_PACKET send()/recv() (l2_packet) */\n'
                  '\t\t\t{ PR_recvfrom,\tFILTER_SYSEXIT },\n'
                  '\t\t\t{ PR_read,\tFILTER_SYSEXIT },\t/* aircrack captures via read() on the AF_PACKET fd */\n'
